var albums = [
  ...
  {
    albumId: 'album2',
    albumCover: 'http://www.fillmurray.com/401/401/',
    albumName: 'Album 2'
  },
  {
    albumId: 'album3',
  ...
  {
    albumId: 'album4',
    albumCover: 'http://www.fillmurray.com/410/410/',
    albumName: 'Album 4'
  },
  {
    albumId: 'album5',
  ...
  {
    albumId: 'album6',
    albumCover: 'http://www.fillmurray.com/398/398/',
    albumName: 'Album 6'
  }
];
...
templates.album = ["<div class='albumBox'>",
    "<a href='#' class='thumbnail' rel='<%= albumId %>'>",
    "<img src='<%= albumCover %>'>",
    "<div class='caption'>",
    "<h3><%= albumName %></h3>",
    "</div></a></div>"].join("");
